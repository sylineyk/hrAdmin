...
<@f.html title="主页"     stylesheet="page" script="common/template,broker/nurseList,common/jquery.twbsPagination.min">
        ...
        <div class="search-edit">
            ...
            <div class="input-list">
                ...
                <div class="inputs">
                    ...
                    <div class="_input fl">
                        <div class="_input fl">
                            <input type="text" class="w300" placeholder="请输入关键字" id="paramStr">
                        </div>
                    </div>
                </div>
            </div>
            <div class="btns btn-box">
                <button type="reset" class="cancel">清除所有条件</button>
                <button class="edit" onclick="queryInfo();return false;">搜索</button>
            </div>
        </div>
    </form>
    <div class="tools-bar">
    <#--<button class="add fl">批量上传</button>-->
        <button class="del fl" onclick="deleteBatch()">批量删除</button>
        <button class="add fr" onclick="toAddNurse()">新增阿姨</button>
    </div>
