...
function queryInfo() {
    ...
    $.ajax({
        type: "GET",
        url: "/admin/view/jsJjrDetail/param/api",
        cache: false,
        dataType: "json",
        data: datas,
...
function queryInfoByPage(currPage) {
    ...
    $.ajax({
        type: "GET",
        url: "/broker/view/jsJjrDetail/param/api",
        cache: false,
        dataType: "json",
        data: datas,
        success: function (data) {
...
function toJjrDetail(phone) {
    var fromDate = $("#fromDate").val();
    var endDate = $("#endDate").val();
    var index = layer.open({
        type: 2,
        title: '详情',
        content: '/admin/view/jsJjrjsDetail?phone=' + phone + "&fromDate=" + fromDate + "&endDate=" + endDate
    });
    layer.full(index);
}