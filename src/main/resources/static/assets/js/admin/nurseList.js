...
function queryInfo() {
    ...
    $.ajax({
        type: "GET",
        url: "/admin/view/nurseList/param/api",
        cache: false,
        dataType: "json",
        data: datas,
...
function toDetail(nurseId) {
    var index = layer.open({
        type: 2,
        title: '阿姨明细',
        content: '/admin/view/nurseDetail/' + nurseId
    });
    layer.full(index);
}
...
function toEdit(nurseId) {
    var index = layer.open({
        type: 2,
        title: '阿姨明细',
        content: '/admin/view/nurseEdit/' + nurseId
    });
    layer.full(index);
}
