...
!function (e, t) {
    ...
    return function (e) {
        ...
        var a = n(1), o = i(a), r = n(7), u = i(r), l = n(8), s = i(l), d = n(9), f = i(d), c = n(11), p = i(c), h = n(13), v = i(h), m = n(15), w = i(m), _ = n(17), g = i(_), y = n(18), b = i(y), k = n(19), x = i(k), M = n(20), C = i(M), j = n(24), E = n(30), S = i(E), O = n(32), P = i(O);
        t.default = {
            dialog: o.default,
            alert: u.default,
            confirm: s.default,
        ...
        function a() {
            ...
            var a = (0, r.default)(r.default.render(l.default, n)), o = a.find(".weui-dialog"), u = a.find(".weui-mask");
        ...
        function a() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : u.default.noop, n = arguments[2];
        ...
        function a() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "", t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : u.default.noop, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : u.default.noop, i = arguments[3];
        ...
        function a() {
            ...
            var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [], i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [], a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
            if (s)return s;
            var o = r.default.os.android;
            a = r.default.extend({menus: n, actions: i, className: "", isAndroid: o}, a);
            var u = (0, r.default)(r.default.render(l.default, a)), d = u.find(".weui-actionsheet"), f = u.find(".weui-mask");
        ...
        function r(e) {
            if (e) {
                var t = (0, f.default)(e.ele), n = e.msg, i = t.attr(n + "Tips") || t.attr("tips") || t.attr("placeholder");
        ...
        function u(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : f.default.noop, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = (0, f.default)(e);
            return i.forEach(function (e) {
                var i = (0, f.default)(e), a = i.find("[required]");
                "function" != typeof t && (t = r);
                for (var u = 0, l = a.length; u < l; ++u) {
                    var s = a.eq(u), d = o(s, i, n.regexp), c = {ele: s[0], msg: d};
        ...
        function u(e, t, u) {
            ...
            l.onload = function (l) {
                ...
                var s = new Image;
                s.onload = function () {
                    var l = n(s), d = o(i(s.src)), f = document.createElement("canvas"), c = f.getContext("2d"), p = t.compress.width, h = t.compress.height, v = s.width, m = s.height, w = void 0;
        ...
        "use strict";
        function n(e) {
            var t = e.url, n = e.file, i = e.fileVal, a = e.onBeforeSend, o = e.onProgress, r = e.onError, u = e.onSuccess, l = n.name, s = n.type, d = n.lastModifiedDate, f = {
                name: l,
                type: s,
        ...
        function r() {
            ...
            function i(e, t) {
                ...
                h.find(".weui-picker__group").eq(t).scroll({
                    items: e, temp: c[t], onChange: function (e, n) {
                        if (e ? f[t] = new o(e) : f[t] = null, c[t] = n, l)r.onChange(f); else if (e.children && e.children.length > 0)h.find(".weui-picker__group").eq(t + 1).show(), !l && i(e.children, t + 1); else {
            ...
            if (_)return _;
            var a = arguments[arguments.length - 1], r = s.default.extend({
                id: "default",
                className: "",
        ...
        function u(e) {
            ...
            }, i = [], a = f.default.parse(t.cron, t.start, t.end), o = void 0;
            do {
                o = a.next();
                var u = o.value.getFullYear(), l = o.value.getMonth() + 1, d = o.value.getDate(), c = n(i, "value", u);
                c || (c = {label: u + "年", value: u, children: []}, i.push(c));
                var p = n(c.children, "value", l);
                p || (p = {
                    label: l + "月",
                    value: l,
                    children: []
                }, c.children.push(p)), p.children.push({label: d + "日", value: d})
            } while (!o.done);
            return r(i, t)
        }

        Object.defineProperty(t, "__esModule", {value: !0});
        var l = n(2), s = a(l), d = n(25), f = a(d);
        n(26);
        var c = n(27), p = i(c), h = n(28), v = a(h), m = n(29), w = a(m);
        ...
        o.default.fn.scroll = function (e) {
            ...
            function n(e) {
                w = e;
                var t = w - m;
                r(v, 0), u(v, g + t), _ = +new Date, y.push({time: _, y: w}), y.length > 40 && y.shift()
            }

            function i(e) {
                if (m) {
                    var t = (new Date).getTime(), n = b - c.bodyHeight / 2;
                    if (w = e, t - _ > 100)M(Math.abs(w - m) > 10 ? w - m : n - w); else if (Math.abs(w - m) > 10) {
                        for (var i = y.length - 1, a = i, o = i; o > 0 && _ - y[o].time < 100; o--)a = o;
                        if (a !== i) {
                            var r = y[i], u = y[a], l = r.time - u.time, s = r.y - u.y, d = s / l, f = 150 * d + (w - m);
                            M(f)
                        } else M(0)
                    } else M(n - w);
                    m = null
            ...
            var a = this, c = o.default.extend({
                ...
                temp: null,
                bodyHeight: 238
            }, e), p = c.items.map(function (e) {
                return '<div class="weui-picker__item' + (e.disabled ? " weui-picker__item_disabled" : "") + '">' + e.label + "</div>"
            }).join(""), h = (0, o.default)(this);
            h.find(".weui-picker__content").html(p);
            var v = h.find(c.scrollable), m = void 0, w = void 0, _ = void 0, g = void 0, y = [], b = window.innerHeight;
            ...
            var M = function (e) {
                ...
                var t = d(c.offset, c.rowHeight), n = f(c.offset, c.rowHeight, c.items.length);
                g > t && (g = t), g < n && (g = n);
        ...
        function a(e) {
            ...
            return n.forEach(function (e) {
                ...
                var a = (0, r.default)(e), o = a.find(".weui-slider__inner"), u = a.find(".weui-slider__track"), l = a.find(".weui-slider__handler"), s = parseInt(r.default.getStyle(o[0], "width")), d = o[0].offsetLeft, f = 0, c = 0, p = void 0;
