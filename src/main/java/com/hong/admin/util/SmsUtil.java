...
public class SmsUtil {
    ...
    static final String accessKeyId = "LTAI0noMDsM9RYEq";
    static final String accessKeySecret = "xU2GhpdOY1rQohLpG7zK4jfAd8CS2r";
    ...
    public static SendSmsResponse sendSms(String phoneNumber, String code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("丑管家服务中心");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_76525011");
